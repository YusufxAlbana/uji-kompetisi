...
<section id="event" class="relative min-h-screen flex items-center justify-center text-white overflow-hidden">
  <!-- Animated Background -->
  <div class="absolute inset-0">
    <img src="{{ asset('assets/images/event.jpeg') }}" alt="Event & Catering" class="w-full h-full object-cover object-center transition-transform duration-1000 hover:scale-105" loading="lazy">
    <div class="absolute inset-0 bg-gradient-to-br from-black/70 via-black/50 to-yellow-900/30"></div>
    
    <!-- Floating Particles -->
    <div class="absolute inset-0 overflow-hidden">
      <div class="absolute top-1/4 left-1/4 w-2 h-2 bg-yellow-400/30 rounded-full animate-pulse"></div>
      <div class="absolute top-3/4 right-1/4 w-3 h-3 bg-yellow-400/20 rounded-full animate-bounce" style="animation-delay: 1s;"></div>
      <div class="absolute top-1/2 left-3/4 w-1 h-1 bg-white/40 rounded-full animate-ping" style="animation-delay: 2s;"></div>
    </div>
  </div>
  ...
  <div class="relative z-10 text-center px-4 max-w-6xl mx-auto">
    ...
    <div class="scroll-animate mb-16">
      <div class="inline-block px-6 py-3 bg-yellow-400/20 backdrop-blur-sm rounded-full mb-8 border border-yellow-400/30">
        <span class="text-yellow-400 text-sm font-semibold tracking-widest">LAYANAN SPESIAL</span>
      </div>
      
      <h1 class="text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-8 tracking-wide relative leading-tight font-serif">
        <!-- Glow Effect Behind Text -->
        <span class="absolute inset-0 blur-3xl opacity-40 bg-yellow-400/60"></span>
        <span class="relative bg-gradient-to-r from-white via-yellow-200 to-white bg-clip-text text-transparent">EVENT</span><br>
        <span class="text-3xl xs:text-4xl sm:text-5xl md:text-6xl relative text-yellow-400">&</span><br>
        <span class="relative bg-gradient-to-r from-white via-yellow-200 to-white bg-clip-text text-transparent">CATERING</span>
      </h1>
      
      <div class="flex items-center justify-center gap-8 mb-8">
        <div class="hidden sm:block w-16 md:w-24 h-0.5 bg-gradient-to-r from-transparent via-yellow-400 to-transparent"></div>
        <div class="w-3 h-3 bg-yellow-400 rotate-45 animate-pulse"></div>
        <div class="hidden sm:block w-16 md:w-24 h-0.5 bg-gradient-to-r from-transparent via-yellow-400 to-transparent"></div>
      </div>
      
      <p class="text-lg md:text-xl text-gray-200 max-w-2xl mx-auto leading-relaxed">
        Wujudkan acara impian Anda dengan layanan event dan catering terbaik dari Rumah Makan Jati
      </p>
    </div>
    ...
    <div class="grid md:grid-cols-2 gap-8 mb-16">
      <!-- Event Card -->
      <div class="scroll-animate group relative bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 hover:border-yellow-400/50 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-yellow-400/20" style="animation-delay: 0.2s;">
        <div class="absolute inset-0 bg-gradient-to-br from-yellow-400/10 to-transparent rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        
        <div class="relative z-10">
          <div class="w-16 h-16 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-2xl flex items-center justify-center mb-6 group-hover:rotate-12 transition-transform duration-500">
      ...
      <!-- Catering Card -->
      <div class="scroll-animate group relative bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 hover:border-yellow-400/50 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-yellow-400/20" style="animation-delay: 0.4s;">
        <div class="absolute inset-0 bg-gradient-to-br from-yellow-400/10 to-transparent rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        
        <div class="relative z-10">
          <div class="w-16 h-16 bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl flex items-center justify-center mb-6 group-hover:rotate-12 transition-transform duration-500">
            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"></path>
            </svg>
          </div>
          
          <h3 class="text-2xl font-bold text-white mb-4 group-hover:text-yellow-400 transition-colors duration-300">Catering Service</h3>
          <p class="text-gray-300 mb-6 leading-relaxed">
            Hidangan lezat dengan cita rasa autentik Indonesia untuk berbagai acara. Dari prasmanan hingga box meal, semuanya tersedia.
          </p>
    ...
    <!-- Action Buttons -->
    <div class="scroll-animate flex flex-col sm:flex-row gap-6 justify-center items-center" style="animation-delay: 0.6s;">
      <!-- Event Button -->
      <a href="https://drive.google.com/file/d/1jrm_TiXaWiE0MHKh0sYmO7kzxRk-aKT4/view" target="_blank" rel="noopener noreferrer" class="group relative inline-flex items-center gap-4 px-10 py-5 bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900 font-bold text-lg rounded-full hover:from-yellow-500 hover:to-orange-600 transition-all duration-300 transform hover:scale-110 shadow-2xl hover:shadow-yellow-500/50 min-w-[200px]">
        <div class="absolute inset-0 bg-white/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        
        <div class="relative flex items-center gap-4">
          <div class="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center group-hover:rotate-180 transition-transform duration-500">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
            </svg>
          </div>
          <span class="group-hover:scale-110 transition-transform duration-300">Paket Event</span>
        </div>
      </a>

      <!-- Catering Button -->
      <a href="https://drive.google.com/file/d/1WBUhh5gqOiIOfwCt9u4BE_SVuWZcKeOt/view" target="_blank" rel="noopener noreferrer" class="group relative inline-flex items-center gap-4 px-10 py-5 bg-gradient-to-r from-green-400 to-emerald-500 text-white font-bold text-lg rounded-full hover:from-green-500 hover:to-emerald-600 transition-all duration-300 transform hover:scale-110 shadow-2xl hover:shadow-green-500/50 min-w-[200px]">
        <div class="absolute inset-0 bg-white/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        ...
        <div class="relative flex items-center gap-4">
          ...
          <span class="group-hover:scale-110 transition-transform duration-300">Menu Catering</span>
        </div>
      </a>
    </div>

    <!-- Contact CTA -->
    <div class="scroll-animate mt-12 p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10" style="animation-delay: 0.8s;">
      <p class="text-gray-300 mb-4">Butuh konsultasi untuk acara Anda?</p>
      <a href="https://wa.me/6285213452474" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-6 py-3 bg-white/10 text-white rounded-full hover:bg-white/20 transition-all duration-300 border border-white/20 hover:border-white/40">
  ...
  <div class="absolute top-10 left-10 w-20 h-20 border-t-2 border-l-2 border-yellow-400/30 animate-pulse"></div>
  <div class="absolute bottom-10 right-10 w-20 h-20 border-b-2 border-r-2 border-yellow-400/30 animate-pulse" style="animation-delay: 1s;"></div>
  <div class="absolute top-1/2 left-10 w-1 h-20 bg-gradient-to-b from-transparent via-yellow-400/30 to-transparent"></div>
  <div class="absolute top-1/2 right-10 w-1 h-20 bg-gradient-to-b from-transparent via-yellow-400/30 to-transparent"></div>
</section>
...
<section class="bg-[#683017] py-0 border-t-4 border-b-4 border-yellow-500">
  <div class="max-w-full mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-0 items-stretch min-h-screen md:min-h-[700px]">
      <!-- Image -->
      <div class="order-2 md:order-1 h-[600px] md:h-auto overflow-hidden brewing-image-container bg-[#683017]">
